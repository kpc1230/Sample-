...
/**
 * SessionActivityItem for Attachment to an Issue within a Session
 */
public class IssueAttachmentSessionActivityItem extends BaseSessionActivityItem {
    ...
    public IssueAttachmentSessionActivityItem(DateTime timestamp, ApplicationUser user, Long issueId, Issue issue, Long attachmentId, Attachment attachment,
                                              Thumbnail thumbnail, ExcaliburWebUtil webUtil) {
