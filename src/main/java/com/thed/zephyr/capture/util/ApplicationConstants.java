...
public class ApplicationConstants {
    ...
    public static final String MAX_SESSION_REINDEX_DYNAMIC_PROP = "reindex.session.max";
    public static final String MAX_SESSION_ACTIVITY_REINDEX_DYNAMIC_PROP = "reindex.session.activity.max";
