...
public interface AttachmentService {
     ...
     String addAttachmentsByThreads(String issueKey, String testSessionId, JSONArray json) throws CaptureRuntimeException, JSONException, RestClientException ,IOException;
}
